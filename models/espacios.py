...
class UPTAEspacios(models.Model):
    ...
    name = fields.Char(string='Nombre', help='Inserte el nombre del espacio a registrar')
    tipos_id = fields.Many2one(comodel_name='upta.espacios.tipos', string='Tipo de Espacio', help='Tipo de espacio (Aula/Laboratorio)')
    pc_num = fields.Integer(string='N° de Computadoras Funcionales', help='Inserte el número de computadoras que se encuentren operativas')
...
class UPTAEspaciosTipos(models.Model):
    ...
    name = fields.Char(string='Nombre', help='Inserte el nombre del tipo de espacio a registrar')
...
class UPTAEspaciosEdificios(models.Model):
    ...
    name = fields.Char(string='Nombre', help='Inserte el nombre del edificio a registrar')
