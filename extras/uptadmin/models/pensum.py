...
class UPTACarreras(models.Model):
    ...
    name = fields.Char(string='Nombre', help='Inserte el nombre de la carrera a registrar')
...
class UPTAMallas(models.Model):
    ...
    identificador = fields.Char(string='Identificador', help='Inserte el identificador de la malla a registrar')
...
class UPTATrayectos(models.Model):
    ...
    name = fields.Char(string="Nombre", compute="_compute_name")
    identificador = fields.Char(string='Identificador', help='Inserte el identificador del trayecto a registrar')
...
class UPTAFases(models.Model):
    ...
    name = fields.Char(string="Nombre", compute="_compute_name")
    identificador = fields.Char(string='Identificador', help='Inserte el identificador de la fase a registrar')
